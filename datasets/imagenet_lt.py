...
def load_imagenet_lt(cfg, transform_train, transform_test, transform_plain):
    root = cfg.root
    
    train_dataset = ImageNet_LT(root, train=True, transform=transform_train)
    train_init_dataset = ImageNet_LT(root, train=True, transform=transform_plain)
    test_dataset = ImageNet_LT(root, train=False, transform=transform_test)
    ...
    train_test_loader = DataLoader(train_init_dataset,
                                    batch_size=cfg.batch_size, shuffle=False,
    ...
    train_givenY = ImageNet_Augmentention(data, partialY.float(), labels.float(), transform_train, transform_plain)
