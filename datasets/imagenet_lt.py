...
#         self.partialY = self.generate_imagenet_partial_labels(
...
#             return image, label, partial_label, name, index
#         else:
...
#     def generate_imagenet_partial_labels(self, train_labels, partial_rate=0.1):
