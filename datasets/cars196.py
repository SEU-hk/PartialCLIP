...
def load_cars196(cfg, transform_train, transform_test):
    ...
    # train_data = torch.load('/mnt/f7a57ea9-f9b0-4806-966e-7f21cbc76421/luoml/MTIL/stanford_cars/devkit/cars_train_annos.mat')
    # 使用scipy.io.loadmat读取.mat文件
    # meta = sio.loadmat('/mnt/f7a57ea9-f9b0-4806-966e-7f21cbc76421/luoml/TAIL/stanford_cars/devkit/cars_meta.mat')
    # classnames = meta['class_names'][0]
    
    # strings = []
    # for element in classnames:
    #     strings.append(element[0])
